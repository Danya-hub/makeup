const procedures = {
	eyelashLamination_botox_eyelashColoring: "Lash lamination + botox (filler) + Eyelash tint (Lash secret / In Lei)",
	eyelashLaminationWithoutBotox_eyelashColoring: "Lamination of eyelashes without Botox (Lash secret / In Lei) + Eyelash color",
	...
	longTermEyebrowStyling_corrections_coloring_specialComposition: "Long term eyebrow styling + Corrections + Contour + Special Composition",
	...
	botox: "Botox",
	laminationEyelashes_botox_modelingAndColoringEyebrowsWithHennaOrPaint: "Lamination eyelashes lash secret + Botox (In Lei + Filler) + Modeling and coloring eyebrows with henna or paint",
	laminationEyelashes_botox_longTermStylingEyebrowsWithColoringAndCorrection: "Lash secret eyelash lamination + Botox (In Lei + Filler) + Long term brow styling with coloring and correction",
